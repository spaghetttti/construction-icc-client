...
export default function UserPreview({ customer, open, onClose }: { customer: UserCardProps; open: boolean; onClose: () => void }) {
  ...
  return (
    <>
                  ...
                  <MainCard>
                    <Stack spacing={2}>
                      ...
                      <Stack spacing={0.5}>
                        ...
                        <Typography>
                          <NumericFormat displayType="text" form="+1 (###) ###-####" suffix="_" defaultValue={customer.contact} />
                        </Typography>
                      </Stack>
                      <Stack spacing={0.5}>
      ...
      >
        <OpenUserCard customer={customer} onCancel={handleAdd} />
      </Dialog>
