...
const LogoMain = ({ reverse, ...others }: { reverse?: boolean }) => {
  ...
  return (
    ...
    <>
      ...
      <svg width="118" height="35" viewBox="0 0 130 35" fill="none" xmlns="http://www.w3.org/2000/svg">
        <text x="10" y="30" font-family={theme.typography.fontFamily} font-weight="bold" font-size="20" fill={theme.palette.common.black}>
          SardorBuild
        </text>
      </svg>
    </>
